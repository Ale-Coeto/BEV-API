...
from BEV.utils.transformations import rotation_matrix
from BEV.utils.geometry import get_slope_intercept_from_abc_line
from BEV.nets import vgg
from BEV.nets import inception_v4
...
def get_overhead_hmatrix_from_4cameraparams(fx, fy, my_tilt, my_roll, img_dims, verbose=False):
    ...
    est_range_u, est_range_v = modified_matrices_calculate_range_output_without_translation(height, width,
                                                                                            ...
                                                                                            verbose=False)
    multiplier = 1.5
    # est_range_v[0] = est_range_v[0] * multiplier
    est_range_v[0] = est_range_v[0] * multiplier
    est_range_u[0] = est_range_u[0] * multiplier
    if verbose:
    ...
    # increase est_range actual range
    # if est_range_u[0] < est_range_u[1]:
    #     est_range_u[0]-=500
    #     est_range_u[1]+=500
    # else:
    #     est_range_u[0]+=500
